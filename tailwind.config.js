...
export default {
  ...
  theme: {
    extend: {
      colors: {
        brand: {
          // Primario — verde neón (2026)
          neon:       '#22c55e',   // green-500 — acento principal
          neonDim:    '#16a34a',   // green-600 — variante oscura
          light:      '#4ade80',   // green-400 — highlight
          // Secundario — violeta (contraste premium)
      ...
      backgroundImage: {
        ...
        // Aurora mesh — verde neón + violeta
        'gradient-mesh':    'radial-gradient(ellipse 100% 80% at 10% 0%, rgba(34,197,94,0.08) 0%, transparent 60%), radial-gradient(ellipse 60% 50% at 90% 10%, rgba(139,92,246,0.07) 0%, transparent 50%), radial-gradient(ellipse 80% 60% at 50% 100%, rgba(34,197,94,0.04) 0%, transparent 60%)',
      ...
      boxShadow: {
        ...
        'colored':  '0 4px 20px rgba(34,197,94,0.14), 0 1px 3px rgba(0,0,0,0.5)',
        ...
        'green':    '0 4px 20px rgba(34,197,94,0.18), 0 1px 3px rgba(0,0,0,0.5)',
      ...
      keyframes: {
        ...
        'pulse-glow': { '0%, 100%': { boxShadow: '0 0 0 0 rgba(34,197,94,0.4)' }, '50%': { boxShadow: '0 0 0 6px rgba(34,197,94,0)' } },
      },
      borderRadius: {
        '2xl': '1rem',
        '3xl': '1.5rem',
